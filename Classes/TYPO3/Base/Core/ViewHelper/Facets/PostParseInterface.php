<?php
namespace TYPO3\Base\Core\ViewHelper\Facets;
 ...
 * This implicates that you usually have to adjust the \TYPO3\Base\View\TemplateView
...
interface PostParseInterface {
	 ...
	 *
	 * @param \TYPO3\Base\Core\Parser\SyntaxTree\ViewHelperNode $syntaxTreeNode The current node in the syntax tree corresponding to this view helper.
	 ...
	 * @param \TYPO3\Base\Core\ViewHelper\TemplateVariableContainer $variableContainer Variable container you can use to pass on some variables to the view.
	 * @return void
	 */
	static public function postParseEvent(\TYPO3\Base\Core\Parser\SyntaxTree\ViewHelperNode $syntaxTreeNode, array $viewHelperArguments, \TYPO3\Base\Core\ViewHelper\TemplateVariableContainer $variableContainer);
