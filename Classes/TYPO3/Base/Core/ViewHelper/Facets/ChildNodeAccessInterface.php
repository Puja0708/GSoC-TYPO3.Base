 ...
 * Right now it is only used internally for conditions, so by subclassing TYPO3\Base\Core\ViewHelpers\AbstractConditionViewHelper, this should be all you need.
 *
 * See \TYPO3\Base\ViewHelpers\IfViewHelper for an example how it is used.
 */
interface ChildNodeAccessInterface {
	/**
	 * Sets the direct child nodes of the current syntax tree node.
	 *
	 * @param array<\TYPO3\Base\Core\Parser\SyntaxTree\AbstractNode> $childNodes
	 * @return void
	 */
