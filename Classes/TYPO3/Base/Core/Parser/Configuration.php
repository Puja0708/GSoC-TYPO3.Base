...
class Configuration {
	 ...
	 *
	 * @param \TYPO3\Base\Core\Parser\InterceptorInterface $interceptor
	 * @return void
	 */
	public function addInterceptor(\TYPO3\Base\Core\Parser\InterceptorInterface $interceptor) {
	 ...
	 *
	 * @param integer $interceptionPoint one of the \TYPO3\Base\Core\Parser\InterceptorInterface::INTERCEPT_* constants,
	 * @return \SplObjectStorage<\TYPO3\Base\Core\Parser\InterceptorInterface>
	 */
