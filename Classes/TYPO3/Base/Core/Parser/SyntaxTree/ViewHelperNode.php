 ...
 */
class ViewHelperNode extends \TYPO3\Base\Core\Parser\SyntaxTree\AbstractNode {
	 ...
	 *
	 * @var \TYPO3\Base\Core\ViewHelper\AbstractViewHelper
	 */
	 ...
	 * Constructor.
	 *
	 * @param \TYPO3\Base\Core\ViewHelper\AbstractViewHelper $viewHelper The view helper
	 * @param array $arguments Arguments of view helper - each value is a RootNode.
	 */
	public function __construct(\TYPO3\Base\Core\ViewHelper\AbstractViewHelper $viewHelper, array $arguments) {
	 ...
	 *
	 * @return \TYPO3\Base\Core\ViewHelper\AbstractViewHelper the attached ViewHelper, if it is initialized
	 */
	 ...
	 *
	 * If the view helper implements \TYPO3\Base\Core\ViewHelper\Facets\ChildNodeAccessInterface,
	...
	public function evaluate(\TYPO3\Base\Core\Rendering\RenderingContextInterface $renderingContext) {
		...
		if ($viewHelper instanceof \TYPO3\Base\Core\ViewHelper\Facets\ChildNodeAccessInterface) {
