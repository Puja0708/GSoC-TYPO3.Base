...
abstract class AbstractGenerator {
	...
	protected function getClassNamesInNamespace($namespace) {
		...
		$allViewHelperClassNames = $this->reflectionService->getAllSubClassNamesForClass('TYPO3\Base\Core\ViewHelper\AbstractViewHelper');
	 ...
	 * Example: For the View Helper TYPO3\Base\ViewHelpers\Form\SelectViewHelper, and the
	 * namespace prefix TYPO3\Base\ViewHelpers\, this method returns "form.select".
	 *
	...
	protected function getTagNameForClass($className, $namespace) {
		...
		$classNameParts = explode(\TYPO3\Base\Base::NAMESPACE_SEPARATOR, $strippedClassName);
